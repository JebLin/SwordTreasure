...
public class Test_base {
    ...
    static {
        ...
        try {
            clazz = Class.forName("indi.sword.util.basic.reflect.BasePerson"); // 传入完整的“包.类”名称实例化Class对象
...
//            Class clazz = x.getClass();
            XClazz = Class.forName("indi.sword.util.basic.reflect.X"); // 传入完整的“包.类”名称实例化Class对象
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public void test_base() {
        System.out.println("clazz.getName() -> " + clazz.getName()); // 得到一个类完整的“包.类”名称 X
